...
import com.example.mp3player.databinding.FragmentFavorlistBinding
...
class FavorlistFragment : Fragment() {
    ...
    lateinit var binding: FragmentFavorlistBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentFavorlistBinding.inflate(inflater, container, false)
    ...
    private fun startProcess() {
        ...
        val dbHelper = DBHelper(requireContext(), MainActivity.DB_NAME, MainActivity.VERSION)
        musicList = dbHelper.selectMusicLike()
    ...
    private fun getMusicList(): MutableList<Music>? {
        ...
        //contentResolver 쿼리 작성을 통해서 musicList로 가져오기
